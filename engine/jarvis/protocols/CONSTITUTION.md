...
| COUNCIL agents | Decisões coletivas | `agents/conclave/` |
...
- Definição (`agents/`) ≠ Memória de runtime (`.claude/agent-memory/`)
...
**Contexto:** YAML workflow engines use declarative orchestration. Mega Brain evaluated this approach.
...
| Mind cloning | "map", "clone", "DNA", "extração" | the knowledge system skills | SKILL |
