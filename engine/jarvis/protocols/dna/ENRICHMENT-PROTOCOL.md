...
> **Output:** knowledge/external/dna/domains/{d}/AGG-{D}.yaml + knowledge/external/dna/domains/{d}/MAP-CONFLITOS-{D}.yaml
...
```yaml
# MCE-4.5: global → per-domain (roundtable 2026-05-17, F-08)
# knowledge/external/dna/domains/{d}/MAP-CONFLITOS-{D}.yaml
...
# MCE-4.5: global → per-domain (roundtable 2026-05-17, F-08)
conflitos:
  path: "knowledge/external/dna/domains/{dominio}/MAP-CONFLITOS-{DOMINIO}.yaml"
