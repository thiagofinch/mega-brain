...
def tool_mission_status() -> dict:
    ...
    mission_id = os.environ.get("MEGA_BRAIN_ACTIVE_MISSION", "MISSION-001")
...
def tool_read_file(file_path: str) -> dict:
    ...
    try:
        ...
        return {"arquivo": file_path, "conteudo": content, "tamanho": full_path.stat().st_size}
    except Exception as e:
        return {"error": str(e)}
    ...
    try:
        ...
        if message_type == "tool-calls":
            ...
            for tool_call in tool_calls:
                ...
                results.append(
                    {"toolCallId": tool_id, "result": json.dumps(result, ensure_ascii=False)}
                )
