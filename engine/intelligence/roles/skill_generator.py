...
Inspirado no NERO pipeline do the knowledge system (128+ skills de 11 personas).
...
Inspiracao: the knowledge system NERO pipeline, formato SKILL.md do Mega Brain
...
from engine.intelligence.entities.entity_normalizer import load_registry
