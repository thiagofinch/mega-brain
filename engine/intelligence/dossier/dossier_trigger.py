...
Grava decision log em logs/triggers.jsonl (padrao the knowledge system)
...
def log_decisions(results):
    """Log trigger decisions to triggers.jsonl (the knowledge system pattern)."""
