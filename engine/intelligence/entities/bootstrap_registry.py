...
from engine.intelligence.entities.entity_normalizer import (
    REGISTRY_PATH,
...
ROLE_TRACKING_DATA = {
    "BDR": {"mentions": 15, "status": "CRIADO", "sources": ["SRC001", "SRC002", "SRC003"]},
    "SDS": {"mentions": 20, "status": "CRIADO", "sources": ["SRC001", "SRC002", "SRC003", "SRC004"]},
    "CLOSER": {
        "mentions": 40,
        "status": "CRIADO",
        "sources": ["SRC001", "SRC004", "SRC002", "SRC003", "SRC004"],
    },
    "SALES-MANAGER": {
        "mentions": 55,
        "status": "CRIADO",
    ...
    "SALES-LEAD": {"mentions": 15, "status": "CRIADO", "sources": ["SRC004"]},
    "SALES-COORDINATOR": {"mentions": 10, "status": "CRIADO", "sources": ["SRC004", "SRC003"]},
    "LNS": {"mentions": 12, "status": "CRIADO", "sources": ["SRC004", "SRC004", "SRC003"]},
    "CUSTOMER-SUCCESS": {"mentions": 12, "status": "CRIADO", "sources": ["G4002", "SRC003"]},
    "SETTER": {"mentions": 15, "status": "CRITICO", "sources": ["SRC003", "SRC002"]},
    "SALES-FARMING": {"mentions": 10, "status": "CRITICO", "sources": ["SRC003"]},
    "HR-DIRECTOR": {"mentions": 8, "status": "IMPORTANTE", "sources": ["SRC005"]},
    "SALES-OPS": {"mentions": 5, "status": "IMPORTANTE", "sources": ["SRC004"]},
    "STAR-EMPLOYEE": {"mentions": 5, "status": "IMPORTANTE", "sources": ["SRC005"]},
    "CUSTOMER-SERVICE": {"mentions": 3, "status": "RASTREAR", "sources": ["SRC005"]},
    "SALES-REP": {"mentions": 2, "status": "RASTREAR", "sources": ["SRC006"]},
    "MARKETING-MANAGER": {"mentions": 1, "status": "RASTREAR", "sources": ["SRC006"]},
}
