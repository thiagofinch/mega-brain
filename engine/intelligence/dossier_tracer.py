...
def main(argv: list[str] | None = None) -> int:
    ...
    for dossier_path in dossiers:
        ...
        if result.traced > 0:
            print(
                f"  {result.traced}/{result.total_paragraphs} paragraphs traced "
            ...
            if dna_count == 0:
                ...
                print(
                    f"  0% coverage ({dna_count} DNA entries, "
    ...
    avg_coverage = round(sum(r.coverage_pct for r in results) / len(results) if results else 0, 1)
