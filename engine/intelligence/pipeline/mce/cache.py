...
Usage::
    ...
    from engine.intelligence.pipeline.mce.cache import MCECache
    ...
    # Cached wrapper
    from engine.intelligence.pipeline.mce.cache import make_cache_key
...
try:
    from engine.paths import DATA, ROUTING
except ImportError:
