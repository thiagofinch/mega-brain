...
Usage::
    ...
    from engine.intelligence.pipeline.mce.log_renderer import render_progressive
...
def _format_details_step3(details: dict[str, Any]) -> list[str]:
    ...
    files_processed = details.get("files_processed", details.get("files"))
...
def _format_details_step5(details: dict[str, Any]) -> list[str]:
    ...
    persons_count = details.get("persons_count")
