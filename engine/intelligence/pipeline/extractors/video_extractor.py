...
Usage:
    from engine.intelligence.pipeline.extractors.video_extractor import (
        extract_video,
...
def is_video_support_available() -> bool:
    ...
    """
    try:
        from engine.intelligence.pipeline.ss_bridge import is_ss_video_available
...
def extract_video(
    ...
    """
    from engine.intelligence.pipeline.ss_bridge import ingest_video, is_ss_video_available
