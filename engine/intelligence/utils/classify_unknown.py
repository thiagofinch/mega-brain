...
# Pastas de destino
DESTINATIONS = {
    "ALEX_HORMOZI": INBOX_BASE / "ALEX HORMOZI (example.com)",
    "JEREMY_HAYNES": INBOX_BASE / "JEREMY HAYNES",
    "consultoria": INBOX_BASE / "education-methodologAO (uma consultoria)",
    "sistema-de-vendas": INBOX_BASE / "um sistema de vendas",
    "COLE_GORDON": INBOX_BASE / "COLE GORDON (example.com)",
    "SAM_OVEN": INBOX_BASE / "SAM OVEN (uma universidade)",
}
...
PATTERNS = {
    ...
    # uma consultoria: formato M1 A1, M2 A2, etc.
    "consultoria": [
    ...
    # um sistema de vendas: CURSO 7/16/21, MOD X AULA Y, CLOSER AGUIA, DIA X
    "sistema-de-vendas": [
    ...
    "COLE_GORDON": [
        ...
        # Colaboradores Cole Gordon (example.com)
        r"um colaborador",
        r"um colaborador",
        r"HYDRA SALES",
        r"SALES Q\s*&?\s*A",
    ...
    # Sam Oven / uma-universidade: workshop, consulting niche
    "SAM_OVEN": [
        r"9 FIGURE WORKSHOP",
...
def classify_file(filename: str) -> str:
    ...
    # Verificação para um sistema de vendas (português com MOD/AULA)
