...
L3_PATTERNS = [
    ...
    # agents/sua-empresa/ removed in Story 4.10
]
...
def main():
    parser = argparse.ArgumentParser(description="Audit Mega Brain repository layer classification")
    parser.add_argument(
        "--output-dir",
        type=str,
        default="docs/audit",
    ...
    for layer, count in sorted(data["summary"]["by_layer"].items()):
        pct = (
            (count / data["summary"]["total_items"] * 100)
