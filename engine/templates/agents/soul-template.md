...
> **Integrado com:** AGENT-COGNITION-PROTOCOL (FASE 1.5), AGENT-INTEGRITY-PROTOCOL, MCE Pipeline (L6-L10)
...
│   └── Core obsessions (L9)
│   └── Temas recorrentes
│   └── Omitido se OBSESSIONS.yaml ausente
│
├── ◆ MINHAS CONTRADICOES [MCE-ENHANCED]
│   └── Paradoxes (L10)
│   └── Tensoes resolvidas
│   └── Omitido se PARADOXES.yaml ausente
│
...
<!-- Section populated from OBSESSIONS.yaml (L9) -->
<!-- OMIT entirely if OBSESSIONS.yaml does not exist -->

{Temas que a pessoa volta repetidamente. Indicadores de prioridade cognitiva.}

- {OBSESSION_1} ^[OBSESSIONS.yaml]
- {OBSESSION_2}
- {OBSESSION_3}
...
<!-- Section populated from PARADOXES.yaml (L10) -->
<!-- OMIT entirely if PARADOXES.yaml does not exist -->

{Posicoes aparentemente contraditorias que coexistem na mente da pessoa.}

### {PARADOX_1_TENSION}

**Posicao A:** {SIDE_A} ^[PARADOXES.yaml]
**Posicao B:** {SIDE_B}
...
*Integrado com AGENT-COGNITION-PROTOCOL (FASE 1.5), AGENT-INTEGRITY-PROTOCOL e MCE Pipeline (L6-L10)*
