...
owner: "pipeline"
date: "2026-04-02"
canonical_scope: "core.templates.phases.sources-compilation"
---
...
> **Output:** `knowledge/external/sources/{PESSOA}/{TEMA}.md`
...
- **Documentos Originais:**
  - [{SOURCE_ID}] → [knowledge/external/inbox/{path}]
...
FOR each PERSON in NARRATIVES_STATE.persons:
  ...
  PERSON_FOLDER = knowledge/external/sources/{PERSON_UPPERCASE}/
...
[ ] CP-POST-6.6.A: Para cada pessoa em NARRATIVES_STATE.persons:
                   knowledge/external/sources/{PESSOA}/_INDEX.md existe
[ ] CP-POST-6.6.B: Para cada tema da pessoa:
                   knowledge/external/sources/{PESSOA}/{TEMA}.md existe
...
│                                                                             │
│  1. BUSCA RÁPIDA:                                                          │
│     → knowledge/external/sources/cole-gordon/SHOW-RATES.md                      │
...
│     → knowledge/external/inbox/COLE GORDON/PODCASTS/7-ways-show-rates.txt│
