...
owner: "pipeline"
date: "2026-04-02"
canonical_scope: "core.templates.phases.dossier-compilation"
---
...
|------|-----------------|--------|
| {TEMA-1} | → [knowledge/external/sources/{PESSOA}/{TEMA-1}.md] | 🟢 |
| {TEMA-2} | → [knowledge/external/sources/{PESSOA}/{TEMA-2}.md] | 🟢 |
...
|--------|-----------------|--------|
| {PESSOA-1} | → [knowledge/external/sources/{PESSOA-1}/{TEMA}.md] | 🟢 |
| {PESSOA-2} | → [knowledge/external/sources/{PESSOA-2}/{TEMA}.md] | 🟢 |
...
Este protocolo cobre dossiês de PESSOA e TEMA (expert/external bucket).
Para outros tipos de dossiê, usar os templates dedicados:

| Variante | Template | Output Path | Quando Usar |
|----------|----------|-------------|-------------|
| PESSOA (expert) | Este protocolo | `knowledge/external/dossiers/persons/` | Consolidar expert individual |
| TEMA (cross-expert) | Este protocolo | `knowledge/external/dossiers/themes/` | Consolidar tema multi-fonte |
| HYBRID (cross-person) | `core/templates/knowledge/dossier-hybrid.md` | `knowledge/external/dossiers/persons/` | Dossiê que combina pessoa + cargo |
| COMPANY | `core/templates/knowledge/dossier-company.md` | `knowledge/business/dossiers/` | Dossiê de empresa/operação |
| OPERATIONAL | `core/templates/knowledge/dossier-operational.md` | `knowledge/business/dossiers/` | Dossiê de processo/meeting |

### HYBRID Dossier (cross-person)

Usado quando um agente de cargo (CLOSER, CRO, CFO) precisa de um dossiê que consolida
contribuições de MÚLTIPLOS experts para UM cargo. Combina DNA de várias fontes com pesos.

Template: `core/templates/knowledge/dossier-hybrid.md`

### COMPANY Dossier

Usado para consolidar conhecimento sobre a operação da empresa: meetings, calls, decisões
internas. Alimentado pelo bucket `knowledge/business/`.

Template: `core/templates/knowledge/dossier-company.md`

### OPERATIONAL Dossier

Usado para consolidar processos operacionais detectados em meetings e calls.
Pode ser promovido a SOP em `workspace/_templates/` após validação.

Template: `core/templates/knowledge/dossier-operational.md`
...
```
core/templates/phases/sources-compilation.md
```

Este protocolo cria arquivos em `knowledge/external/sources/{PESSOA}/{TEMA}.md` para consolidar
