...
| 11 | OBSESSIONS.yaml | {path} | {CREATED / UPDATED / MERGED} |
| 12 | PARADOXES.yaml | {path} | {CREATED / UPDATED / MERGED} |
...
| 5b | OBSESSIONS.yaml exists | {PASS / FAIL} | {N} obsessions |
| 5c | PARADOXES.yaml exists | {PASS / FAIL} | {N} paradoxes |
...
*Template: engine/templates/logs/MCE-PIPELINE-LOG-TEMPLATE.md*
````
...
# engine/intelligence/pipeline/mce/orchestrate.py
