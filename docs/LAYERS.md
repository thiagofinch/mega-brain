...
**Purpose:** The open-source engine that powers Mega Brain. Distributed via npm as `AIOX-GPS-ai`. Anyone can install and use this to build their own knowledge management system.
