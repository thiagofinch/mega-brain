...
This project is maintained exclusively by the **project maintainer**. All official updates and releases are published by the maintainer only.
...
4. All PRs require approval from the **maintainer** before merge
