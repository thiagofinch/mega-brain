...
|--------|-------------------|-----------|
| `chunks-state.schema.json` | `/processing/chunks/CHUNKS-STATE.json` | Chunks extraídos das fontes |
| `canonical-map.schema.json` | `/processing/canonical/CANONICAL-MAP.json` | Mapa de entidades canônicas |
| `insights-state.schema.json` | `/processing/insights/INSIGHTS-STATE.json` | Insights extraídos |
| `narratives-state.schema.json` | `/processing/narratives/NARRATIVES-STATE.json` | Narrativas sintetizadas |
