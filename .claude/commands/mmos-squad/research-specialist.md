...
dependencies:
  ...
  data:
    - mmos-kb.md
  services:
    - file-service  # Document parsing via .aiox/infrastructure/services/file-service
    - google-drive  # Storage via .aiox/infrastructure/services/google-drive
    - tiktok        # Social collection via .aiox/infrastructure/services/tiktok
