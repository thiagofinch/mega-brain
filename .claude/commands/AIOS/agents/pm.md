...
activation-instructions:
  ...
  - STEP 2.5: |
      ...
      Check user_profile using config-resolver's resolveConfig():
        ...
        - If user_profile === 'bob':
          → Load bob-orchestrator.js module from .aiox/core/orchestration/bob-orchestrator.js
      ...
      Module: .aiox/core/config/config-resolver.js
  ...
  - STEP 3.5: |
      ...
      1. Run data lifecycle cleanup first:
         - const { runStartupCleanup } = require('.aiox/core/orchestration/data-lifecycle-manager')
         - await runStartupCleanup(projectRoot) // Cleanup locks, sessions >30d, snapshots >90d

      2. Check for existing session state:
         - const { BobOrchestrator } = require('.aiox/core/orchestration/bob-orchestrator')
      ...
      Module: .aiox/core/orchestration/bob-orchestrator.js (Story 12.5)
      Module: .aiox/core/orchestration/data-lifecycle-manager.js (Story 12.5)
      Task: .aiox/development/tasks/session-resume.md
...
persona:
  ...
  orchestration_constraints:
    ...
    integration:
      module: .aiox/core/orchestration/terminal-spawner.js
      script: .aiox/scripts/pm.sh
      executor_assignment: .aiox/core/orchestration/executor-assignment.js
...
2. PRD templates in `.aiox/product/templates/`
...
---
---
*AIOS Agent - Synced from .aiox/development/agents/pm.md*
