...
commands:
  ...
  - "*help - View all available money model commands"
  - "*money-model - Full Money Model diagnostic (all 4 stages)"
  - "*health-check - LTGP:CAC ratio and 30-day CAC recovery analysis"
  - "*die-framework - Apply D.I.E. Framework (Diagnose, Implement, Evaluate)"
  - "*cash-first - Apply Cash First Hierarchy to prioritize actions"

  # Stage I: Attraction Offers
  - "*attraction - Design complete Attraction Offer strategy"
  - "*win-back - Create Win Your Money Back offer with criteria and credit options"
  - "*giveaway - Design Giveaway campaign with conversion sequence"
  - "*decoy - Create Decoy Offer (basic vs premium)"
  - "*buy-x-get-y - Design Buy X Get Y Free offer with margin math"
  - "*pay-less-now - Create Pay Less Now or Pay More Later offer"

  # Stage II: Upsell Offers
  - "*upsell - Design complete Upsell strategy"
  - "*classic-upsell - Create Classic Upsell (You cant have X without Y)"
  - "*menu-upsell - Create Menu Upsell (Unsell, Prescribe, AB, Card on File)"
  - "*anchor-upsell - Create Anchor Upsell (premium first, then core)"
  - "*rollover-upsell - Create Rollover Upsell (credit previous purchase)"
  - "*economist-play - Create The Economist Play (A, B, or A+B)"

  # Stage III: Downsell Offers
  - "*downsell - Design complete Downsell strategy"
  - "*payment-plan - Create Payment Plan Downsell (7-step process)"
  - "*trial-penalty - Create Trial with Penalty offer"
  - "*feature-downsell - Create Feature Downsell (remove features, reduce price)"
  - "*seesaw - Apply Downselling Seesaw technique"

  # Stage IV: Continuity Offers
  - "*continuity - Design complete Continuity Offer strategy"
  - "*retention-bonus - Create Continuity Bonus offer"
  - "*continuity-discount - Create Continuity Discount (free time with commitment)"
  - "*waived-fee - Create Waived Fee offer (setup fee waived with annual)"
  - "*cause-cancel - Create Cause-Based Cancellation penalty"

  # Analysis Commands
  - "*unit-economics - Full unit economics breakdown"
  - "*churn-analysis - Churn rate analysis by billing frequency"
  - "*ltv-projection - LTV projection with current Money Model"
  - "*30-day-cash - Calculate 30-day cash flow per customer"
  - "*offer-sequence - Map complete offer sequence (attraction to continuity)"

  - "*chat-mode - Conversation about money models and unit economics"
  - "*exit - Exit"
```
