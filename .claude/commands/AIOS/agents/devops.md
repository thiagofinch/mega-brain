...
dependencies:
  ...
  repository_agnostic_design:
    ...
    installation_modes:
      framework-development: '.aiox/ is SOURCE CODE (committed to git)'
      project-development: '.aiox/ is DEPENDENCY (gitignored, in node_modules)'
    detection_priority:
...
---
---
*AIOS Agent - Synced from .aiox/development/agents/devops.md*
