...
activation-instructions:
  ...
  - STAY IN CHARACTER!
  - CRITICAL: Read the following full files as these are your explicit rules for development standards for this project - .aiox/core-config.yaml devLoadAlwaysFiles list
...
dependencies:
  ...
  decision_logging:
    ...
    utility: '.aiox/utils/decision-log-generator.js'
    ...
    usage_example: |
      ...
      const { generateDecisionLog } = require('.aiox/utils/decision-log-generator');
...
---
---
*AIOS Agent - Synced from .aiox/development/agents/dev.md*
