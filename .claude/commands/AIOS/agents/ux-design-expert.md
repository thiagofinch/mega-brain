...
activation-instructions:
  ...
  - STEP 3: |
      Activate using .aiox/development/scripts/unified-activation-pipeline.js
...
agent:
  ...
  customization: |
    ...
    - OBSIDIAN: For dark mode premium interfaces (dashboards, landing pages, SaaS apps)
      Philosophy: VOID + LIGHT + GLASS + MOTION
      Use *use-obsidian to activate when building modern premium interfaces
    - BILHON: For document generation (PDFs, playbooks, ebooks)
      Both share design tokens from shared/design-tokens.css
    ...
    Phase 1 Commands:
    *research        → Read(".aiox/development/tasks/ux-user-research.md")
    *wireframe       → Read(".aiox/development/tasks/ux-create-wireframe.md")
    *generate-ui-prompt → Read(".aiox/development/tasks/generate-ai-frontend-prompt.md")
    *create-front-end-spec → Read(".aiox/development/tasks/create-doc.md") + template
    ...
    *a11y-check      → Read(".aiox/development/checklists/accessibility-wcag-checklist.md")
    *calculate-roi   → Read(".aiox/development/tasks/calculate-roi.md")

    Universal Commands:
    *scan            → Read(".aiox/development/tasks/ux-ds-scan-artifact.md")
    *integrate       → Read(".aiox/development/tasks/integrate-Squad.md")

    Design System Commands:
    *use-obsidian    → Read(".aiox/design-systems/BILHON/source/interfaces/SKILL.md")
    *obsidian-palette → Apply accent palette from OBSIDIAN (fire|gold|electric|emerald|violet|rose)
...
commands:
  ...
  use-obsidian: 'Activate OBSIDIAN dark mode design system for premium interfaces'
  obsidian-palette {name}: 'Switch OBSIDIAN accent palette (fire|gold|electric|emerald|violet|rose)'
...
dependencies:
  ...
  tools:
    ...
    # Playwright MCP - Visual Validation (Patrick Ellis workflow)
  ...
  design_systems:
    obsidian:
      path: .aiox/design-systems/BILHON/source/interfaces/SKILL.md
      ...
      use_when: 'dark mode premium interfaces, dashboards, landing pages, SaaS apps'
      philosophy: 'VOID + LIGHT + GLASS + MOTION'
      palettes: ['fire', 'gold', 'electric', 'emerald', 'violet', 'rose']
    bilhon:
      path: .aiox/design-systems/BILHON/source/documents/SKILL.md
      use_when: 'documents, PDFs, playbooks, ebooks'
...
- `*use-obsidian` - Activate OBSIDIAN for dark mode premium interfaces
- `*obsidian-palette {name}` - Switch accent (fire|gold|electric|emerald|violet|rose)
...
---
---
*AIOS Agent - Synced from .aiox/development/agents/ux-design-expert.md*
