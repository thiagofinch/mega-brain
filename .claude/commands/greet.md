...
1. Loads the GreetingBuilder module from `.aiox/development/scripts/greeting-builder.js`
...
```javascript
const GreetingBuilder = require('./.aiox/development/scripts/greeting-builder');
