# SKILL-PROCESS-JARVIS
## Padrões do comando /process-jarvis

> **Auto-Trigger:** Processamento de novo material, comando /process-jarvis
> **Keywords:** "processar", "process-jarvis", "pipeline-jarvis", "pipeline", "jarvis", "novo material", "inbox"
> **Prioridade:** ALTA
...
`/process-jarvis` é o nome canônico user-facing.
`/pipeline-jarvis` existe apenas como alias interno/de compatibilidade retroativa.

Garantir que todo processamento via `/process-jarvis` siga:
...
checklist = {
    ...
    "id_gerado": True           # Ex: SRC004, AH-HR002
}
```
...
### Output: SOURCE-[ID].md
```markdown
# SOURCE: SRC004 - Cole Gordon - [Título]
...
|----|------|------|----------|
| SRC004 | Video | [Data] | 32 |
| SRC004 | PDF | [Data] | 18 |
| SRC004 | Video | [Data] | 45 |
| SRC004 | Video | [Data] | 47 |
```
...
```
════════════════════════════════════════════════════════════════
📊 PROCESSAMENTO CONCLUÍDO: SRC004
════════════════════════════════════════════════════════════════
...
ARQUIVOS GERADOS
├── /processing/chunks/SRC004-chunks.json
├── /processing/insights/SRC004-insights.json
├── /knowledge/SOURCES/cole-gordon/SOURCE-SRC004.md
