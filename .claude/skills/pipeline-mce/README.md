...
and produces: chunked content, resolved entities, 10-layer DNA (L1-L5 cognitive +
L6-L10 MCE identity), Voice DNA, behavioral patterns, identity layers
(values/obsessions/paradoxes), dossiers, source compilations, and fully-generated
mind-clone agents.
...
| DNA YAMLs (L1-L5) | `knowledge/external/dna/persons/{slug}/` |
| OBSESSIONS.yaml (L9) | `knowledge/external/dna/persons/{slug}/OBSESSIONS.yaml` |
| PARADOXES.yaml (L10) | `knowledge/external/dna/persons/{slug}/PARADOXES.yaml` |
