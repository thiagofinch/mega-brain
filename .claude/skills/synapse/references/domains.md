...
# Source: mega-brain-core/development/agents/dev.md
...
For the domain file template, see: `.claude/skills/synapse/assets/domain-template`

For the manifest entry template, see: `.claude/skills/synapse/assets/manifest-entry-template`
...
| `mega-brain-core/core/synapse/domain/domain-loader.js` | Domain parser (SYN-1) |
