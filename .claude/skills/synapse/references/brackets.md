...
The bracket system is implemented in `mega-brain-core/core/synapse/context/context-tracker.js`.
...
The output formatter (`mega-brain-core/core/synapse/output/formatter.js`) enforces token budgets:
...
| File | Purpose |
|------|---------|
| `mega-brain-core/core/synapse/context/context-tracker.js` | Bracket calculation, token budgets, layer configs |
| `.synapse/context` | Bracket-specific context rules (L1) |
| `mega-brain-core/core/synapse/output/formatter.js` | Token budget enforcement + truncation |
