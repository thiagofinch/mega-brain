...
The manifest is parsed by `domain-loader.js` (`mega-brain-core/core/synapse/domain/domain-loader.js`) on every prompt.
...
| `mega-brain-core/core/synapse/domain/domain-loader.js` | Manifest parser + domain file loader |
| `.claude/skills/synapse/references/manifest.md` | Detailed parser format spec |
| `.claude/skills/synapse/assets/manifest-entry-template` | Template for new manifest entries |
