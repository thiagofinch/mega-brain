...
SYNAPSE processes rules through an 8-layer pipeline executed sequentially on every prompt. Each layer has a specific purpose, trigger condition, and priority level. The engine orchestrator (`mega-brain-core/core/synapse/engine.js`) chains all layers and the output formatter produces the final `<synapse-rules>` XML block.
...
| **Source** | Auto-generated from `mega-brain-core/constitution.md` via `generate-constitution.js` |
| **Implementation** | `mega-brain-core/core/synapse/layers/l0-constitution.js` |
...
| **Implementation** | `mega-brain-core/core/synapse/layers/l1-global.js` |
...
| **Implementation** | `mega-brain-core/core/synapse/layers/l2-agent.js` |

**Agents covered:** dev, qa, architect, pm, po, sm, devops, analyst, data-engineer, ux (ux-design-expert), mega-brain-master, squad-creator.
...
| **Implementation** | `mega-brain-core/core/synapse/layers/l3-workflow.js` |
...
| **Implementation** | `mega-brain-core/core/synapse/layers/l4-task.js` |
...
| **Implementation** | `mega-brain-core/core/synapse/layers/l5-squad.js` |
...
| **Implementation** | `mega-brain-core/core/synapse/layers/l6-keyword.js` |

### L7: Slash-Skill / Explicit Command Routing

| Property | Value |
|----------|-------|
| **Purpose** | Detect and inject explicit mode/routing directives (`*brief`, `*dev`, `*synapse status`, etc.) |
...
| **Implementation** | Internal L7 processor module in `mega-brain-core/core/synapse/layers/` |
...
[SQUAD: knowledge-system] Squad-specific rules
...
| `mega-brain-core/core/synapse/layers/l0-constitution.js` | L0 processor |
| `mega-brain-core/core/synapse/layers/l1-global.js` | L1 processor |
| `mega-brain-core/core/synapse/layers/l2-agent.js` | L2 processor |
| `mega-brain-core/core/synapse/layers/l3-workflow.js` | L3 processor |
| `mega-brain-core/core/synapse/layers/l4-task.js` | L4 processor |
| `mega-brain-core/core/synapse/layers/l5-squad.js` | L5 processor |
| `mega-brain-core/core/synapse/layers/l6-keyword.js` | L6 processor |
| Internal L7 processor module | L7 processor |
| `mega-brain-core/core/synapse/layers/layer-processor.js` | Abstract base class |
| `mega-brain-core/core/synapse/output/formatter.js` | XML formatter + token budget |
