...
# Story MCE-11.19: read from thresholds.yaml if available; fallback to hardcoded 3.
try:
    import sys as _sys
    ...
    MAX_AGE_DAYS: int = _get_th("inbox_age.urgent_days", default=3)
except Exception:
    MAX_AGE_DAYS = 3
ALERT_LOG = PROJECT_ROOT / ".data" / "logs" / "inbox_alerts.jsonl"
