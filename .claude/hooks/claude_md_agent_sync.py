...
Hook Events: PostToolUse (Write/Edit to agents/ or ecosystem-registry.yaml)
Version: 1.0.0
"""
...
ECOSYSTEM_REGISTRY = BASE_DIR / "agents" / "_registry" / "ecosystem-registry.yaml"
AGENTS_DIR = BASE_DIR / "agents"
SYNC_LOG = BASE_DIR / ".data" / "logs" / "claude-md-sync.jsonl"
...
def should_trigger(file_path: str) -> bool:
    ...
    triggers = ["ecosystem-registry.yaml", "agents.yaml"]
...
Defined in `agents/_registry/ecosystem-registry.yaml`, activated via slash commands.
