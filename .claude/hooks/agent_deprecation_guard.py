...
WATCHED_DIRS = [
    ...
    "engine/intelligence/pipeline/mce/",
    "engine/intelligence/rag/",
    "engine/intelligence/",
    "engine/templates/phases/",
    ".claude/hooks/",
]
...
def find_watched_dir(rel_path: str) -> str:
    ...
    # e.g. engine/intelligence/pipeline/mce/ before engine/intelligence/
...
def scan_agents(matched_dir: str, file_name: str, rel_path: str):
    ...
    for pattern in AGENT_GLOBS:
        ...
        for agent_file in glob_mod.glob(full_pattern):
            ...
            # e.g., if matched_dir is engine/intelligence/pipeline/mce/,
            # also check engine/intelligence/pipeline/
...
def main():
    ...
    is_template = file_path.endswith(".md") and "engine/templates/" in file_path
