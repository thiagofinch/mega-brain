...
CRITICAL_FILES = {
    ...
    "memory_owner": {
        "paths": [".claude/jarvis/JARVIS-MEMORY.md"],
        "required": True,
        "max_age_hours": 72,
    },
    ...
    "soul": {"paths": ["system/02-JARVIS-SOUL.md"], "required": True, "max_age_hours": 720},
    "latest_session": {
        "paths": [".claude/sessions/LATEST-SESSION.md"],
        "required": False,
        "max_age_hours": 168,
    },
    "boot_sequence": {
...
def load_latest_session() -> dict | None:
    ...
    session = {"raw": content, "session_id": None, "summary": "", "pending": [], "next_steps": []}
