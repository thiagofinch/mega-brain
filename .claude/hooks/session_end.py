...
def create_default_state():
    ...
    return {
        "jarvis": {"version": "1.0.0", "installed_at": datetime.now().isoformat()},
        "session": {"id": None, "started_at": None, "last_action_at": None, "is_active": False},
        "current_state": {
            "phase": 0,
            "phase_name": "IDLE",
            "status": "ready",
        ...
        "next_action": {"description": "Aguardando instruções", "priority": "normal"},
        "metrics": {"sessions_total": 0, "files_processed": 0, "insights_extracted": 0},
    }
